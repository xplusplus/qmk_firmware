...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    [1] = LAYOUT_65( /* MO(1) - Fn */
        ...
        _______,       _______,  _______, _______,_______, _______, _______, _______, _______, _______, KC_PSCR,  KC_SLCK, KC_PAUS, RESET,    KC_END,
        CTL_T(KC_CAPS),RGB_SPI,  RGB_SPD, _______,_______, _______, _______, _______, _______, _______, _______,  _______,          EEP_RST,  KC_PGUP,
        KC_LSFT,       _______,  _______, _______,_______, _______, _______, _______, _______, _______, _______,  KC_MPLY,          KC_VOLU,  KC_PGDN,
        _______,       _______,  _______,                  _______,                   _______,          _______,  KC_MPRV,          KC_VOLD,  KC_MNXT
    ),

    [2] = LAYOUT_65( /* MO(2) - RShift */
